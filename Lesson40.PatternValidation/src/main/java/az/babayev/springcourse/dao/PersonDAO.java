...
public class PersonDAO {
    ...
    public void update(int id, Person person) {
        String UPDATE_QUERY = "UPDATE person SET name=?, surname=?, age=?, email=?,address=? WHERE id=?";
        jdbcTemplate.update(UPDATE_QUERY, person.getName(), person.getSurname(), person.getAge(), person.getEmail(),person.getAddress(), id);
    }
