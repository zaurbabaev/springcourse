...
public class PersonDAO {
...

    {
        ...
        people.add(new Person(++PERSON_COUNT, "Tom", "Tommi", 34,"tom@xyz.az"));
        people.add(new Person(++PERSON_COUNT, "Bob", "Bobbi", 40,"bob@xyz.az"));
        people.add(new Person(++PERSON_COUNT, "Mike", "Mikael", 20,"mike@xyz.ru"));
        people.add(new Person(++PERSON_COUNT, "Katy", "Kataline", 15,"katy@xyz.az"));
    }
